        ...
        <div className="relative isolate overflow-hidden bg-transparent px-6 py-24 sm:py-20 lg:overflow-visible lg:px-0 container mx-auto">
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
                ...
                <div className="lg:pr-4">
                    ...
                    <h1 className="mt-2 text-4xl font-semibold tracking-tight text-pretty text-blue-900 sm:text-5xl">
                ...
                <div className="lg:pr-4">
                    ...
                    <h2 className="mt-16 text-2xl font-bold tracking-tight text-blue-600">
                        Let’s work together
                    </h2>
                    <p className="mt-6">
